...
/*
 * displayNumber convert each digit depending on space.
 */
void displayNumber(int valor)
{
...
/*
 * setDisplay method allows to return int value to display in protoboard.
 */
void setDisplay(int dig1, int dig2, int dig3, int dig4, int dig5, int dig6, int dig7, int dig8)
{
	GPIOC->ODR = D1 + numeros[dig8];
	HAL_Delay(1);
	GPIOC->ODR = D2 + numeros[dig7];
	HAL_Delay(1);
	GPIOC->ODR = D3 + numeros[dig6];
	HAL_Delay(1);
	GPIOC->ODR = D4 + numeros[dig5];
	HAL_Delay(1);
	GPIOC->ODR = D5 + numeros[dig4];
	HAL_Delay(1);
	GPIOC->ODR = D6 + numeros[dig3];
	HAL_Delay(1);
	GPIOC->ODR = D7 + numeros[dig2];
	HAL_Delay(1);
	GPIOC->ODR = D8 + numeros[dig1];
	HAL_Delay(1);
}
